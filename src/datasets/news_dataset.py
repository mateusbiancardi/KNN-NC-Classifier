...
class NewsDataset(DatasetInterface):
    def __init__(self, path: str, train_path: str) -> None:
        ...
        # Diferenciar train e test
        # Tirar a stopword do train e criar uma lista de palavras diferentes
    ...
    def get(self, idx: int) -> Tuple[Any, str]:
        ...
        trainWords = self.train_words()

        # Criar vetor zerado com mesmo num de palavras
        # Para cada palavra do test, incrementar frequencia usando index()
